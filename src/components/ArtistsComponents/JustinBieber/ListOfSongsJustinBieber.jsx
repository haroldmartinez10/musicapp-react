...
const ListOfSongsJustinBieber = () => {

    const { songs, setIsPlaying, currentSong, setCurrentSong, audioElem } = useContext(ContextJustinBieber)
...
export default ListOfSongsJustinBieber