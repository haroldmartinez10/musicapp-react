...
const ListOfSongsBadBunny = () => {

    const { songs, setIsPlaying, currentSong, setCurrentSong, audioElem } = useContext(ContextArticMonkeys)
...
export default ListOfSongsBadBunny