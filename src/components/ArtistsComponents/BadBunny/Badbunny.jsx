...
import ListOfSongsBadBunny from './ListOfSongsBadBunny'
...
const Badbunny = () => {
  ...
  const { songs, isPlaying, setIsPlaying, currentSong, setCurrentSong, audioElem } = useContext(ContextBadBunny)
      ...
      <ArtistDivContainer className='mx-auto flex-wrap  lg:flex space-x lg:w-[980px]'>
        ...
        <div className='w-12/12 mt-4 gap-2 px-2 w-12/12 md:mx-auto md:w-6/12 lg:w-6/12'>
          <motion.div
            ...
            <Link to='/BadBunny/AboutBadBunny'><motion.button onClick={() => setIsPlaying(false)}
