...
const ListOfSongsLanaDelRey = () => {

  const { songs, setIsPlaying, currentSong, setCurrentSong, audioElem } = useContext(ContextLanaDelRey)
...
export default ListOfSongsLanaDelRey